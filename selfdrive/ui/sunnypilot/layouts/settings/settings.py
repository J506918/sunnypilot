...
from openpilot.selfdrive.ui.sunnypilot.layouts.settings.dashbox import DashBoxLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.SUNNYLINK: PanelInfo(tr_noop("DashBox"), DashBoxLayout(), icon="icons/wifi_strength_full.png"),
